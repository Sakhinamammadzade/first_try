        ...
        <div className="bg-[#131921] p-4 flex  items-center justify-between md:px-8">
            ...
            <div className="flex items-center w-full">
                <div className="hidden sm:flex  relative w-full mx-4">
                    ...
                    <button className="absolute text-[#131911] h-full w-12 left-0 flex items-center justify-center rounded-r-full">
                        <GoSettings />
                    </button>
            ...
            <div className="relative flex items-center justify-center text-white text-[28px]">
                <BsCart2 />
                <div className="absolute h-full text-[16px] -top-3.5 right-2.1 text-orange-300">
                    <p>0</p>
                </div>
            </div>
